...
// Format words in groups for display
export function formatWords(words: string[], groupSize: number = 3): string {
  const groups: string[] = [];
...
// Check if a string looks like BIP39 words
export function isBIP39Format(input: string): boolean {
